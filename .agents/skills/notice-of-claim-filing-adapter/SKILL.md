...
In user-facing replies, keep the implementation black-box. Describe only whether the filing step
is ready, what facts still need correction, and what the user should review before submission.
...
3. If the draft is not ready, return blocking gaps in plain language without drifting back into intake.
4. If the draft is ready, proceed internally to the filing-preparation step without exposing implementation details.
